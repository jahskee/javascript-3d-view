<?php
   ...
   $car_model = "edge";
   $car_year = "2016";
   $asset_path = "cars/".$car_make."/".$car_model."/".$car_year."/";

/*
$car_make = "bmw";
$car_model = "b094";
$asset_path = "cars/".$car_make."/".$car_model."/";
*/
...
<script>
    ...
    function init() {
        ...
        spotLight1.position.set( 100, 100, 50 );
        ...
        mtlLoader.setBaseUrl('<?= $asset_path; ?>');
